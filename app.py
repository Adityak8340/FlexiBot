...
def main():
    ...
    spacer, col = st.columns([3, 1])  
    with col:  
        st.image('FlexiBot.jpg')

    # The title and greeting message of the Streamlit application
    st.title("Chat with FlexiBot!")
    st.write("Hi! I'm FlexiBot, your responsive and friendly chatbot. I can help with question and provide information. And I'm super quick! Let's begin our conversation!")
    ...
    typing_speed = st.sidebar.slider('Typing speed (ms per letter):', 1, 20, value=10)
    ...
    speech_button = st.button("Use Speech Input")
    if speech_button:
        st.write("Please click the button below and start speaking.")
